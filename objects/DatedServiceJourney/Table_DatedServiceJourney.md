...
| ServiceAlteration | ServiceAlterationEnumeration | 0..1 | Deviation type. Allowed values: `planned` · `cancellation` · `replaced` · `extraJourney`. Omitted implies `planned`. | ServiceAlteration |
